...
<html lang="en">
    <head>
        ...
        <title>Conditions Générales || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    <h2 class="text-center mb-4">Conditions Générales</h2>
                    <hr>
                    <p class="text-muted text-center">L'utilisation de la plateforme <strong>LeBoutiquier </strong>est régie par un conrat d'adhésion stricte.
                        L'accès est personnel et non transmissible. L'utilisateur s'engage à saisir des informations sincères et véritables. Toutes tentative de
                        manipulation du <strong>code source ou d'accès non autorisé aux bases de données fera l'objet de poursuites. </strong>Le développeur décline
                        toute responsabilité en cas de perte de données ou à une défaillance du matériel local.
                    </p>
                    <hr>
                </div>
            </div>
