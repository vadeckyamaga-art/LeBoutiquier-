...
<html lang="en">
    <head>
        ...
        <title>Conseil de sécurité || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    <h2 class="text-center mb-4">Conseil de Sécurité</h2>
                    <hr>
                    <p class="text-muted text-center">  La sécurité de vos données personnelles et commerciales est notre priorité absolue. Nous vous recommandons d'adopter des mots de passe 
                        <strong>complexes (mélangeant chiffres, lettres et symboles) </strong>et de ne jamais les noter à proximité du poste de travail. Mefiez-vous des tentatives de phishing: 
                        <strong>aucun menbre de notre équipe technique nous vous demandera votre mot de passe par téléphone. </strong> Enfin, assurez-vous de vous déconnecter dès que vous quitter votre 
                        poste pour éviter toutes manipulations non autorisées de votre compte.
                    </p>
                </div>
            </div>
        </div>
