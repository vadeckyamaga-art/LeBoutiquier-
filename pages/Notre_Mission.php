...
<html lang="en">
    <head>
        ...
        <title>Notre mission || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    ...
                    <hr>
                    <p class="text-muted text-center">Notre mission est de démocratiser l'accès au numérique pour tous les commerçants. Nous croyons que la digitalisation
                        ne doit pas etre un luxe ou une barrière technique. En automatisant les taches répétitives comme la publicité autour des articles ou le calcul des stocks,
                        nous permettons aux gérants de se concentrer sur l'essentiel: <strong>la relation client l'expansion de leurs activité. LeBoutiquier </strong> s'engage à  
                        fournir une interface robuste, disponible <strong>24h/24, </strong>garantissant une intégrité totale de vos ventes.
                    </p>
                    <hr>
                </div>
            </div>
