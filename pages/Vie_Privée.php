...
<html lang="en">
    <head>
        ...
        <title>Vie Privée || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    <h2 class="text-center mb-4">Vie Privée</h2>
                    <hr>
                    <p class="text-muted text-center"> Conformément aux normes de protrction des données, <strong>LeBoutiquier </strong>garantit que vos <strong>informations personnelles et vos quantités en stock </strong>,
                        restent strictement confidentiels. Ces données sont stockées sur des serveurs sécurisés et ne sont en aucun cas revendues à des fins publicitaires. Seul l'administrateur principal a le pouvoir de
                        définir qui peut consulter les données sensibles du commerçant.
                    </p>
                </div>
            </div>
        </div>
