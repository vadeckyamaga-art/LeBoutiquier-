...
<html lang="en">
    <head>
        ...
        <title>Aide & FAQ || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    <h2 class="text-center mb-4">Aide & FAQ</h2>
                    <hr>
                    <p class="text-muted text-center">Nous avons conçu <strong>LeBoutiquier </strong>pour qu'il soit le plus simple possible. Cependant, vous pouvez <a href="Contact.php" target="_blank">nous contacter </a>, 
                        nos administrateur sont à votre disposition pour vous repondre dans les plus bref délais. Que ce soit pour comprende comment interpreter un <strong>graphique de vente </strong>, comment 
                        <strong> réinitialiser un accès utilisateur</strong>, ou comment <strong>passer une commande </strong>, nous avons documenté chaque fonctionnalité. 
                    </p>
                    <hr>
                    <h3 class="text-center mb-4">FAQ (Foire Aux Questions)</h3>
                    <div class="mb-3">
                    </div>
                </div>
            </div>
