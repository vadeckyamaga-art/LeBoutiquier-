...
<html lang="en">
    <head>
        ...
        <title>Page non disponible || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    <h1 class="text-center mb-4">404</h1>
                    <p class="text-center">Page non disponible!</p>
                    <hr>
                    <p class="text-muted text-center">Oups ! Cette option n'est pas encore développée.<strong> A très bientot... 😊</strong></p>
                    <hr>
                </div>
            </div>
        </div>
