...
<html lang="en">
    <head>
        ...
        <title>Vendre un Article || LeBoutiquier</title>
        ...
        <div class="leb-login-wrapper">
            ...
            <div class="leb-login-center py-5">
                <div class="leb-login-form-container">
                    <h2 class="text-center mb-4">Vendre un Article</h2>
                    <hr>
                    <p class="text-muted text-center"> Le module de vente est le coeur battant de l'application. Chaque commande est enregistrée avec une précision chirurgicale
                        incluant <strong>l'heure, l'utilisateur responsable et le mode de reception de l'article. </strong>Dès validation, le stock physique est mis à jour instantanément, 
                        vous évitant les ruptures imprévues. L'interface est optimisée pour la rapidité, permettant de servir vos clients sans attente, meme mors des périodes de forte 
                        affluence.
                    </p>
                </div>
            </div>
